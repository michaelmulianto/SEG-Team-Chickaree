# Generated by Django 3.2.5 on 2021-12-10 12:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='GenericRoundOfMatchesInterface',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
            ],
        ),
        ...
        migrations.CreateModel(
            name='SingleGroup',
            fields=[
                ('genericroundofmatchesinterface_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='clubs.genericroundofmatchesinterface')),
                ('winners_required', models.IntegerField(default=1)),
            ],
            bases=('clubs.genericroundofmatchesinterface',),
        ),
        migrations.CreateModel(
            name='StageInterface',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clubs.genericroundofmatchesinterface')),
            ],
            options={
                'ordering': ['group'],
            },
