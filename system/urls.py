...
urlpatterns = [
    ...
    path('apply_to_club/<int:club_id>', views.withdraw_application_to_club, name = 'withdraw_application_to_club'),
    path('withdraw_application_to_club/<int:club_id>', views.apply_to_club, name = 'apply_to_club'),
